...
- Learn about gradient ascent/descent
- Apply Logistic Regression to the task of face recognition.
"""
...
- Loop N times (or until convergence)
   ...
   - Update the weight entries based on current values of w, gradient, and learning rate alpha
- Return weights w
"""
